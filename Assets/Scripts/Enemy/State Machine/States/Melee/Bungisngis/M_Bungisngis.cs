...
public class M_Bungisngis : MeleeEnemyEntity, IDamageable, IEnemyDataGetable
{

    public M_Bungisngis_S_AttackState attackState { get; private set; }
    public M_Bungisngis_S_DeathState deathState { get; private set; }
    public M_Bungisngis_S_IdleState idleState { get; private set; }
    public M_Bungisngis_S_MovingState movingState { get; private set; }
    ...
    public override void Awake()
    {
        ...
        attackState = new M_Bungisngis_S_AttackState(stateMachine, CREATURE_ATTACK, this, this);
        deathState = new M_Bungisngis_S_DeathState(stateMachine, CREATURE_DEATH, this, this);
        movingState = new M_Bungisngis_S_MovingState(stateMachine, CREATURE_MOVE, this, this);
        idleState = new M_Bungisngis_S_IdleState(stateMachine, CREATURE_IDLE, this, this);
